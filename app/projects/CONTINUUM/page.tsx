...
const translations = {
  en: {
    ...
    description3: "The project’s materiality is defined by the demanding structural requirements of the building. The use of steel pillars, beams, and trusses is essential to ensure stability while allowing for large spans and open interior spaces. All structural elements are prefabricated in order to optimize construction time and simplify the building process. To facilitate assembly on site, a system of intermediate connecting pieces is developed, allowing the structure to be easily and efficiently executed. Through the use of steel plates and IPE/ HEB profiles, a steel connector links the three dimensions of the structure by means of a bolted system. This strategy ensures structural clarity, pre- cision, and adaptability, while reinforcing the modular logic of the project. The expressed structure becomes an integral part of the architectural lan- guage, defining both the spatial organization and the material identity of the building. Regarding the facades, the south-east orientation is treated with a double-skin system that incorporates solar protection. This system con- sists of a steel substructure combined with vertically sliding perforated steel panels, allowing the facade to adapt to varying solar gains and lighting re- quirements throughout the day. The adjustable envelope improves thermal comfort while maintaining visual permeability and a strong relationship with the exterior. The stairs are constructed using tramex in order to achieve a lightweight appearance while maintaining continuity in material expression.",
    description4: "The Continuum presents it self with four main facilities : cultural, communi- tary, sport centers and a kinder-garden. As the project inscribes it self as an invitation to enter the building through a series of public spaces, the interior distribution keeps the same spirit. Even if the structure is very clear and it permits modularity the decision was to put all of the functional areas on one end of the building, leaving the Southern part be the main hall and circulation for the users. This permits to have less climate control on the bigger areas that are the common spaces of each center and to have only the individual rooms be closed and climatically controlled. On the northern facade we find the main communication, a series of stairs that link directly each level. We can note that we also have stairs on the public gardens to not have a big concentration of people circulating on the side but rather seize the opportu- nity of the promenade through the terrace to move up and down.",
    description5: "The slabs are composed of mixed concrete systems, with a CLT finish applied to the interior surfaces to provide warmth and contrast to the steel structure. On the terraces, the integration of vegetation contributes to the creation of a climatic shelter for users, reinforcing the project’s relationship with nature. For the multisport ground, a textile shading system is implemented to pro- tect users from excessive solar radiation. These material and environmental strategies enhance comfort throughout the Continuum, while allowing each area to respond specifically to its functional and climatic requirements."
},
  es: {
    title: "CONTINUUM",
